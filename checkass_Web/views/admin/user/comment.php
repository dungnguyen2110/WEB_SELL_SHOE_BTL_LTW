                     ...
                     <div class="search-results">
                        <?php 
                          while($result_user = $all ->fetch_assoc()){
                            echo'
                            <a href="/checkass_Web/admin/user/comment/' . $result_user['id'] . '" style="text-decoration:none;">
                  ...
                  <div class="main-information">
                     <div class="item-information">
                        ...
                        <div class="item-options">
                           ...
                           <a id="comm" href="#" class="item-option is-active">Comments</a>
                        </div>
                     </div>
                     <div class="item-detail">
                        ...
                        <table class="all-details">
                           <thead>
                            ...
                            <tbody>
                                <?php 
                                    while($result_comment = $all_comment->fetch_assoc()){
                                        echo'<tr>
                                        <td>' .
                                          $result_comment['date'] . '
                                        </td>
                                        ...
                                        <td>';
                                          if($result_comment['product_id'] !=NULL){ echo $result_comment['product_id'] ;} else {echo 'x';}
                                       echo '</td>
                                      <td>';
                                      if($result_comment['news_id'] !=NULL){ echo $result_comment['news_id'] ;} else {echo 'x';}
                                       echo '</td>
                                      <td>' . '<a type="button" class="btn btn-danger del-btn" onclick="return confirm('; echo "'" . 'Bạn có muốn xóa bình luận này?' . "'";   echo ')" href="/checkass_Web/admin/user/delete_comment/' . $result_comment['id'] . '"' .'>Delete</a>' . '</td>
                                       </tr>';
                                    }
