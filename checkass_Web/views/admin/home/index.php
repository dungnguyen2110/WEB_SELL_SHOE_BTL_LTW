                              ...
                              <?php
                                 ...
                                 while($admin = $all_admin->fetch_assoc()) {
                                    ...
                                    <tr>
                                       ...
                                       <td>';
                                       if($admin['id']!=$_SESSION['id_admin']) { echo '<a type="button" class="btn btn-danger del-btn" onclick="return confirm('; echo "'" . 'Bạn có muốn xóa admin này không?' . "'";   echo ')" href="/checkass_Web/admin/home/delete/' . $result_product['id'] . '"' .'>Delete</a>';}
