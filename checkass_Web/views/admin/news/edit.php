            ...
            <div class="content-wrapper">
               <div class="main-information">
                     ...
                     <div class="item-detail">
                        <form action="/checkass_Web/admin/news/edit_news/<?php echo $id; ?>"  method="post">
                            <div>
                            <div class="signin-part-name" id="error" style="color: red; font-size: 11px; font-weight: bold; padding-left: 6px;"></div>
                                ...
                                <div>
                                <button id="edit-btn" type="button" style="color: #000; border: solid; font-size: 25px; margin-left: auto; margin-right: auto; border-radius: 5px;">Save</button>
                            </div>
                        </form>
                     </div>
