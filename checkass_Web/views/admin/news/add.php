...
<html lang="en">
               ...
               <div class="main-information">
                     <div class="item-information">
                        <div class="item-options">
                           <a href="/checkass_Web/admin/news/index" class="item-option">All News</a>
                           <a href="/checkass_Web/admin/news/add" class="item-option is-active">Add News</a>
                        </div>
                     </div>
                     <div class="item-detail">
                        <form action="/checkass_Web/admin/news/add_news" method="post">
                            <div>
                            <div class="signin-part-name" id="error" style="color: red; font-size: 11px; font-weight: bold; padding-left: 6px;"></div>
                                ...
                                <div>
                                <button id="add-btn" type="button" style="color: #000; border: solid; font-size: 25px; margin-left: auto; margin-right: auto; border-radius: 5px;">Add News</button>
                            </div>
                        </form>
                     </div>
    ...
    <?php include_once('views/main/footer.php');   ?>
        ...
        <script src="/checkass_Web/public/js/admin/news/add_news.js"></script>
