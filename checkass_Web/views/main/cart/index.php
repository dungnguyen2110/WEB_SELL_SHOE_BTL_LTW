        ...
        <div class="cart">
          ...
          <div class="calc-cost">
            <div class="calc-cost-item">
              <div class="cost-note">Tổng cộng:</div>
        ...
        <div class="signin-part-name" id="error" style="color: red; font-size: 11px; text-align: center; font-weight: bold;"></div>
            <div class="information">
              ...
              <span class="information-input">
                <input class="clean-slide" id="name" name="name" type="text" /><label for="fullname">Họ và tên</label>
              </span>
              <span class="information-input">
                <input class="clean-slide" id="phone" name="phone" type="text" /><label for="phonenumber">Điện thoại</label>
              </span>
              <span class="information-input">
                <input class="clean-slide" id="location" name="location" type="text" /><label for="location">Địa chỉ</label>
              </span>
            </div>
            <div class="payment-part-name">Phương thức thanh toán:</div>
            ...
            <div class="confirm-payment">
              <button type="button" id="pay-btn" class="blog-slider__button" data-cid=<?php echo $_SESSION['id']?>>THANH TOÁN</button>
            </div>
          </div>
        </form>
        </div>
