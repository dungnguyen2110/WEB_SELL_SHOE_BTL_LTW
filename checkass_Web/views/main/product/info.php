                                                    ...
                                                    <button class="product-slider__cart" id="add_cart" data-pid="<?php echo $info_product['id']; ?>" data-uid="<?php if(isset($_SESSION['id'])) { echo $_SESSION['id'];} ?>" data-check="<?php if(isset($_SESSION['id'])) {if($check == 1){echo 1;} else {if($info_product['quantity'] == 0) {echo 3;} else {echo 2;}}}?>">
                                                        <?php
                                                            if(isset($_SESSION['id'])) {
                                                                ...
                                                                echo '<a href="#" onclick="alert('.  "'Đăng nhập để mua hàng'" . ')" style="text-decoration:none; color:black;"> THÊM VÀO GIỎ HÀNG </a>';
                                                            }
                                                        ?>
                                                    </button>
                                                </div>
                                            ...
                                            <div class="comment-head">
                                                ...
                                                if(isset($_SESSION['id'])) { 
                                                    if($value['comment_out']['user_id'] == $_SESSION['id']) {
                                                        echo '<a onclick="return confirm('; echo "'" . 'Bạn có muốn xóa sản phẩm?' . "'";   echo ')" href="/checkass_Web/main/product/delete_comment/' . $value['comment_out']['id'] . '/'. $info_product['id']. '" style="text-decoration:none;">' . '<i class="fa fa-times"></i></a>';
                                                    }
                                                }
                                            echo '
                                            </div>
